...
CONTAINS
    ...
    FUNCTION ISOTime(iCurrentTime) RESULT(sDate)
    
        ! Routine arguments
        INTEGER, INTENT(IN) :: iCurrentTime
        CHARACTER(LEN=19)   :: sDate
        ...
        WRITE(sDate,"(i4.4,2('-',i2.2),1x,i2.2,2(':',i2.2))") iYear, iMonth, iDay, iHour, iMinute, iSecond
        
    END FUNCTION ISOTime
